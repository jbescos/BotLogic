...
public class ClientWS {
	...
	private final String URL = bundle.getString("host.url");
	private final String LOGIN = bundle.getString("login.user");
	private final String PASSWORD = bundle.getString("login.password");

	public List<DtoOut<Map<String, Set<String>>>> getFromAudio(File audio) throws IOException {
		...
		try {
			...
			// TODO check response codes and login if neccesary
